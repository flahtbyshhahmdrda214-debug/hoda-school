...
import { School, Newspaper, Users, Image, ArrowUpRight, Trophy, Type, UserCheck } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Link
              to="/admin/members"
              className="w-full flex items-center justify-between p-3 rounded-xl bg-slate-50 hover:bg-emerald-50 hover:text-emerald-700 text-xs font-semibold text-slate-700 transition-colors"
            >
              <span>+ ویرایش اعضا و ارکان مجتمع</span>

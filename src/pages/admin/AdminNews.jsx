            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="/uploads/general/cover.webp یا آدرس اینترنتی"
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-6 py-2.5 bg-turquoise-600 text-white rounded-xl text-xs font-bold hover:bg-turquoise-500 transition-colors"
                >
